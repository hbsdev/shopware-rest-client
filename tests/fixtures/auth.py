...
def read_conf():
  ...
  if os.environ.get('SWAPI_COMPAT_SW4') == "1":
    sw4_compat = True
  elif os.environ.get('SWAPI_COMPAT_SW4') == "0":
    sw4_compat = False
  else:
    raise Exception("Set environment SWAPI_COMPAT_SW4 to 0 or 1.")

  return proto, server, basepath, user, key, use_query_plugin, sw4_compat
